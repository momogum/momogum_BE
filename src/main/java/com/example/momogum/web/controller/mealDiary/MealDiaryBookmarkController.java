...
public class MealDiaryBookmarkController {
    ...
    public ApiResponse<String> toggle(@AuthenticationPrincipal CustomUserDetails userDetails, // userId 값을 Principal을 통해 가져오도록 수정
    ...
    @GetMapping("")
    public ApiResponse<List<MealDairiesDTO.GetAllMealDiaryResponseDTO>> get(@AuthenticationPrincipal CustomUserDetails userDetails){
